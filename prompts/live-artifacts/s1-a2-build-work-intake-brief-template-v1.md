# Build Work intake brief template as a Claude Live Artifact + Scheduled Task
...
- **Artifact:** Work intake brief template
...
- **Primary users:** Function owners, project managers, Will, James, Kim, Nico, Oliver, Alina.
...
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Work_Intake_Rules.md
...
- Stuart_Executive_Growth_System_v0_6/05_GTM_Command_Centre/Marketing_Launch_Brief_Template.md
- Stuart_Executive_Growth_System_v0_6/05_GTM_Command_Centre/Leadership_Decision_Note_Template.md
...
**Copy/export target:** Save as `Work intake brief template Source Pack`.
...
2. The row or rows related to: Work intake brief template
...
- Stuart_Executive_Growth_System_v0_6/05_GTM_Command_Centre/Marketing_Launch_Brief_Template.md
- Stuart_Executive_Growth_System_v0_6/05_GTM_Command_Centre/Leadership_Decision_Note_Template.md
4. Connected sources: Outlook, Teams, OneDrive, Monday.com, HubSpot where request context matters.
...
**Copy/export target:** Paste/import block into `Work intake brief template` artifact.
...
Request, objective, audience, owner, deadline, source evidence, decision needed, risk, output format.
...
Brief ID, requester, owner, objective, audience, source links, decision needed, deadline, definition of done, risk, approval path.
...
**Copy/export target:** Save as `Work intake brief template Build Spec`.
...
Primary users:
Function owners, project managers, Will, James, Kim, Nico, Oliver, Alina.
...
Required buttons:
New brief, check completeness, copy brief, return for resubmission, export markdown.

Required views:
Drafts, ready for Stuart, returned for resubmission, by owner, by project.

Local/persistent state needed:
Draft briefs, templates, missing-field checklist, resubmission notes.

Copy/export needs:
Copy brief into Teams, email, Monday item, or project document.

Human approval gate:
Owner confirms the brief before Stuart reviews any decision request.
...
Weekday Incomplete Brief Scan

Scheduled task prompt:
Scan Outlook, Teams, Monday.com, OneDrive and HubSpot where relevant since the last run for requests to Stuart that lack owner, objective, deadline, source evidence, definition of done or decision path. Return: incomplete request table, missing fields, safe return-to-sender draft, and JSON import block for the Work Intake Brief Template. No source writeback or automatic approvals.
...
**Success test:** Run three live requests through the template and return one incomplete brief.
...
Automation hint:
Possible later automation: return incomplete brief drafts to requester. Not automation-ready until the intake template is accepted and used manually for four cycles.
