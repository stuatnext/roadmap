# Build Owner-to-owner routing map v1
...
```text
I am building the NEXT.io live artifact: Owner-to-owner routing map.
...
Use this trigger:
Start with 10 recent owner-chase or middleman examples.
...
Create the v1 artifact spec for: Owner-to-owner routing map.
...
Create a manual test script for: Owner-to-owner routing map.
...
```text
Here is what happened after testing Owner-to-owner routing map:
[paste test notes]

Review against this success test:
Repeated asks reach the correct owner without Stuart forwarding them.
