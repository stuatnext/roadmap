# Build Owner-to-owner routing map as a Claude Live Artifact + Scheduled Task
...
- **Artifact:** Owner-to-owner routing map
...
- **Primary users:** Stuart, function owners, project managers, direct reports.
...
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Stop_Doing_Register.md
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Ownership_Map.md
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Decision_Rights_Register.md
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Delegation_Responses.md
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Stakeholder_Operating_System/Delegation_And_Boundary_Scripts.md

Connected/live sources to use if available:
- Outlook, Teams, Monday.com, OneDrive, HubSpot where deal context matters.
...
**Copy/export target:** Save as `Owner-to-owner routing map Source Pack`.
...
2. The row or rows related to: Owner-to-owner routing map
...
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Delegation_Responses.md
- Stuart_Executive_Growth_System_v0_6/01_Stuart_Command_Centre/Stakeholder_Operating_System/Delegation_And_Boundary_Scripts.md
4. Connected sources: Outlook, Teams, Monday.com, OneDrive, HubSpot where deal context matters.
...
**Copy/export target:** Paste/import block into `Owner-to-owner routing map` artifact.
...
Request type, project, current sender, expected output, named owner, decision needed, deadline, evidence.
...
Request type, correct owner, backup owner, Stuart decision right, escalation path, evidence, redirect script, last validated, notes.
...
**Copy/export target:** Save as `Owner-to-owner routing map Build Spec`.
...
Primary users:
Stuart, function owners, project managers, direct reports.
...
Required buttons:
Add route, search route, copy soft redirect, copy direct redirect, export map, flag unclear owner.

Required views:
By function, by project, by owner, unclear ownership, Stuart decision rights.

Local/persistent state needed:
Saved routes, filters, draft changes, validation date.

Copy/export needs:
Copy redirect message. Export CSV or markdown for Monday, Teams, or leadership review.

Human approval gate:
Stuart or relevant function owner approves a route before it becomes the rule.

What not to build:
No automatic reassignment, source writeback, auto-escalation, or live sync.
...
**Success test:** Classify 10 recent asks, validate owners, use redirects for one week.
...
Test against:
Classify 10 recent asks, validate owners, use redirects for one week.
...
Automation hint:
Possible later automation: owner-routing exception roll-up or message draft routing. Not automation-ready until the routing map works for four cycles and routes are stable.
