# Update your proof base and compensation narrative
...
**Task goal:** A clean internal and external proof file.

**Success test:** One proof file updated.
...
I am working on this roadmap task: Update your proof base and compensation narrative.

Why it exists from my questionnaire answers:
You said you feel underpaid and under-recognised, while your CV shows commercial proof that is stronger than your self-perception.
...
Problem: Your internal value is under-packaged.
Cause: You need a proof base for pay, influence and market positioning.
...
Task: Update your proof base and compensation narrative
Required output: A clean internal and external proof file.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: A clean internal and external proof file.
