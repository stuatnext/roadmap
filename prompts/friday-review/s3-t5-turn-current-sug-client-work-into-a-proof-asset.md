# Turn current SUG client work into a proof asset
...
**Task goal:** One anonymised case study or before-after proof note.

**Success test:** One proof block created.
...
I am working on this roadmap task: Turn current SUG client work into a proof asset.

Why it exists from my questionnaire answers:
You said proof is thin but you have current client work moving a business from spreadsheets to HubSpot and improving lead gen with Apollo.
...
Problem: Proof is thin.
Cause: Current client work is not yet packaged as a case study or proof asset.
...
Task: Turn current SUG client work into a proof asset
Required output: One anonymised case study or before-after proof note.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: One anonymised case study or before-after proof note.
...
Capture separate reusable blocks: offer insight, prospect list, outreach copy, discovery questions, proof asset, website update note, and follow-up task.
