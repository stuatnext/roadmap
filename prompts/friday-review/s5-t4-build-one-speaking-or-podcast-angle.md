# Build one speaking or podcast angle
...
**Task goal:** One tight topic, pitch and target list.

**Success test:** One pitch created. Three targets identified.
...
I am working on this roadmap task: Build one speaking or podcast angle.

Why it exists from my questionnaire answers:
You said you want speaking opportunities and have moderated panels before, but you lack a repeatable way to turn your opinions into market-facing angles.
...
Problem: Speaking opportunities need packaging.
Cause: Your opinions have not been converted into a clear talk or podcast angle.
...
Task: Build one speaking or podcast angle
Required output: One tight topic, pitch and target list.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: One tight topic, pitch and target list.
...
One pitch created. Three targets identified.
