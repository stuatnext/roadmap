# Run one live commercial decision memo
...
**Task goal:** One live decision becomes a short, structured memo.

**Success test:** One decision memo produced and used.
...
I am working on this roadmap task: Run one live commercial decision memo.

Why it exists from my questionnaire answers:
You said you need commercial and business leadership coaching, especially to challenge your strategies and build confidence.
...
Problem: Commercial judgement needs reps.
Cause: You need coaching attached to live decisions, not abstract learning.
...
Task: Run one live commercial decision memo
Required output: One live decision becomes a short, structured memo.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: One live decision becomes a short, structured memo.
...
One decision memo produced and used.
