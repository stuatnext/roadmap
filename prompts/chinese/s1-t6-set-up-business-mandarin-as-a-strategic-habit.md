# Set up Business Mandarin as a strategic habit
...
**Fallback:** Gemini App  
**Asset to use:** Chinese Business Track

**Task goal:** A working Business Mandarin note and four 15-minute practice blocks per week.

**Success test:** Four short sessions completed this sprint.
...
```text
Use ChatGPT Project. If this needs document tone, long writing, or Microsoft 365 context, use Gemini App.

I am working on this roadmap task: Set up Business Mandarin as a strategic habit.

Why it exists from my questionnaire answers:
You said learning Chinese could change your opportunities and should have been treated as strategic for Singapore, not as a random hobby.
...
Problem: Chinese is strategically important but not operationalised.
Cause: It has no tiny recurring habit tied to Singapore or business conversations.
...
Use this asset if useful: Chinese Business Track.
...
Task: Set up Business Mandarin as a strategic habit
Required output: A working Business Mandarin note and four 15-minute practice blocks per week.
Minimum version: Do one 15-minute practice and save five useful phrases.
Full version: A working Business Mandarin note and four 15-minute practice blocks per week.
...
Capture separate reusable blocks: vocabulary list, 60-second script, roleplay prompt, spaced repetition cards, weekly practice task, and Singapore relationship phrase bank.
...
Four short sessions completed this sprint.
