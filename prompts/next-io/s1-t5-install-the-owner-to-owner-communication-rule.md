# Install the owner-to-owner communication rule
...
**Task goal:** A simple rule and response bank that routes communication back to the correct owner.

**Success test:** One middleman request redirected.
...
I am working on this roadmap task: Install the owner-to-owner communication rule.

Why it exists from my questionnaire answers:
You said you are pulled into being the middleman between colleagues and that NEXT.io has messy communication channels with weak ownership.
...
Problem: You are acting as human glue between owners.
Cause: People route communication through you because ownership norms are weak.
...
Task: Install the owner-to-owner communication rule
Required output: A simple rule and response bank that routes communication back to the correct owner.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: A simple rule and response bank that routes communication back to the correct owner.
...
One middleman request redirected.
