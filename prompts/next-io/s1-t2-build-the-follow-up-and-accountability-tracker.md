# Build the Follow-Up and Accountability Tracker
...
**Task goal:** One tracker showing who owes what, by when, what is blocked and what message to send next.

**Success test:** Tracker used 4 times. One blocked decision becomes visible.
...
I am working on this roadmap task: Build the Follow-Up and Accountability Tracker.

Why it exists from my questionnaire answers:
You said chasing approvals, decisions, and missing information is one of the highest-friction workflows an agent could absorb. You also said you chase too much from memory.
...
Problem: Follow-up chaos is draining attention.
Cause: Requests, deadlines and blockers are scattered across memory, email, Teams and meetings.
...
Task: Build the Follow-Up and Accountability Tracker
Required output: One tracker showing who owes what, by when, what is blocked and what message to send next.
Minimum version: Create the five columns you will use today and add three live items.
Full version: One tracker showing who owes what, by when, what is blocked and what message to send next.
...
Tracker used 4 times. One blocked decision becomes visible.
