# Set up the next 30-day sprint without hardcoded dates
...
**Task goal:** A new current sprint selected with 3 active tasks and a Friday review routine.

**Success test:** Next sprint configured without creating a new system.
...
I am working on this roadmap task: Set up the next 30-day sprint without hardcoded dates.

Why it exists from my questionnaire answers:
You said Today and This Week would go stale. This task sets the next sprint without hardcoded dates.
...
Problem: Static weekly plans go stale.
Cause: The roadmap needs a reusable sprint-setting method.
...
Task: Set up the next 30-day sprint without hardcoded dates
Required output: A new current sprint selected with 3 active tasks and a Friday review routine.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: A new current sprint selected with 3 active tasks and a Friday review routine.
...
Next sprint configured without creating a new system.
