# Run the manual Follow-Up System for two weeks
...
**Task goal:** Evidence that the follow-up workflow saves time and reduces missed actions.

**Success test:** Used 8 times across the sprint. Clear evidence of saved time or unblocked decisions.
...
I am working on this roadmap task: Run the manual Follow-Up System for two weeks.

Why it exists from my questionnaire answers:
You said chasing people is the workflow you know AI could help with, but you have not built the architecture yet.
...
Problem: The follow-up workflow is the best first AI candidate.
Cause: It is painful, recurring, and has clear inputs and outputs.
...
Task: Run the manual Follow-Up System for two weeks
Required output: Evidence that the follow-up workflow saves time and reduces missed actions.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: Evidence that the follow-up workflow saves time and reduces missed actions.
...
Used 8 times across the sprint. Clear evidence of saved time or unblocked decisions.
