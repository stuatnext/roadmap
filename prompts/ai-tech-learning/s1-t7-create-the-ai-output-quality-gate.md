...
**Task goal:** A checklist that every serious AI output must pass before you use it.

**Success test:** Any output scoring under 7 out of 10 is rewritten or ignored.
...
I am working on this roadmap task: Create the AI Output Quality Gate.

Why it exists from my questionnaire answers:
You said AI outputs often miss existing assets, misunderstand nuance, hallucinate, and become surface-level unless the prompt is excellent.
...
Problem: AI trust is low.
Cause: Outputs are not being judged against a repeatable quality gate before use.
...
Task: Create the AI Output Quality Gate
Required output: A checklist that every serious AI output must pass before you use it.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: A checklist that every serious AI output must pass before you use it.
