# Build the Commercial Strategy Critic manual workflow
...
**Task goal:** A reusable critic prompt for pricing, GTM, targets and strategy.

**Success test:** One strategy improves before a meeting.
...
```text
Use ChatGPT Project. If this needs document tone, long writing, or Microsoft 365 context, use Google AI Studio.

I am working on this roadmap task: Build the Commercial Strategy Critic manual workflow.

Why it exists from my questionnaire answers:
You said you do not trust AI with commercial decisions because it can invent competitor facts, assumptions, and bad calculations.
...
Problem: AI can help with commercial critique but cannot own decisions.
Cause: You need a manual workflow with human approval gates.
...
Task: Build the Commercial Strategy Critic manual workflow
Required output: A reusable critic prompt for pricing, GTM, targets and strategy.
Minimum version: Complete the smallest version that creates a real-world action within 48 hours.
Full version: A reusable critic prompt for pricing, GTM, targets and strategy.
...
One strategy improves before a meeting.
