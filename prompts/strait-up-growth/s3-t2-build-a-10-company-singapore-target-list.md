# Build a 10-company Singapore target list
...
**Task goal:** Ten named Singapore prospects with pain hypothesis and opener angle.

**Success test:** 10 targets listed. 5 messages drafted.
...
I am working on this roadmap task: Build a 10-company Singapore target list.

Why it exists from my questionnaire answers:
You said Singapore should be the first market, but you do not yet know the companies, buyers, mentors, or ecosystem well enough.
...
Problem: The Singapore market is still abstract.
Cause: You have not built a small, specific target list.
...
Task: Build a 10-company Singapore target list
Required output: Ten named Singapore prospects with pain hypothesis and opener angle.
Minimum version: Create low, base and stretch numbers with one assumption each.
Full version: Ten named Singapore prospects with pain hypothesis and opener angle.
...
10 targets listed. 5 messages drafted.
